...
class NewPlan extends Component {
  ...
  render() {
    ...
    const preImgArr = [
      ...
      "curryRoastedCauliflower",
      "pickledCarrotsCelery",
      "blueCheese",
      "goatCheese",
      "shavedParmesan",
      "parmesanCrisp",
    ...
    const dressingsImgArr = [
      "peppercornTahinaDressing",
      "cranberryMapleVinaigrette",
      "greenGoddessRanchDressing",
      "balsamicVinaigrette",
      "balsamicVinegar",
      "caesarDressing",
      "extraVirginOliveOil",
      "limeCilantroJalapenoDressingVinaigrette",
    ...
    const saveData = async () => {
      ...
      await addNewCombo({
        ...
        Bowl: [
          getJson(baseContents),
          getJson(premContents),
          getJson(topContents),
          getJson(dressingContents),
        ],
        OwnerEmail: localStorage.getItem("user"),
        Owner: localStorage.getItem("user"),
        Smoothie: this.state.smoothie.toString(),
      });
    };
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="text-center">
              <label htmlFor="bowlName">BOWL NAME:</label>
              <br></br>
              <input
                type="text"
                id="bowlName"
            ...
            <div>
              <div className="col-md-12 mb-4 text-center">
                <h1 id="subtitle" className="main-heading">
                  Base
                </h1>
                <div className="underline mx-auto"></div>
              </div>
